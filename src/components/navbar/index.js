					...
					<Row className={styleArray(['justify-content-between', styles.headerRow])}>
						...
						<Collapse isOpen={this.state.isOpen} navbar>
							<Nav className="ml-auto" navbar>
								<NavItem>
									<NavLink className={styles.navLink} href="/">Все товары</NavLink>
								</NavItem>
								<NavItem>
									<NavLink className={styles.navLink} href="https://github.com/designneexx/test_react_cars">GitHub</NavLink>
								</NavItem>
							</Nav>
						</Collapse>
					</Row>

...
import {Alert, Col, Container, Row, Spinner, Button, Jumbotron} from 'reactstrap'; //Импорт reactstrap (Bootstrap для react)
			...
			<React.Fragment>
				...
				<Col xs={12} md={12} lg={12}>
					<Jumbotron className="justify-content-center align-items-center text-center">
						...
						<hr className="my-2" />
						<div>
							<Link className={styleArray(['btn', 'btn-success', styles.btnOffsetR])} to="/">Вернуться на главную</Link>
